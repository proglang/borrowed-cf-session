...
This section contains \cref{fig:omitted-predicates,fig:session-laws}.
...
This section contains \cref{fig:values-evaluation-contexts,fig:expression-reduction,fig:configuration-congruence}.
...
This section contains \cref{fig:translated-congruence}.
...
This section contains \cref{fig:context-operators,fig:constraint-simplification}.
...
This section contains \cref{fig:typing-normalisation}.
...
If \lstinline|T1| and \lstinline|T2| are the translated types from the equivalence constraint, 
it is easy to see that this program only typechecks, if \lstinline|T1| and
\lstinline|T2| are equivalent session types.

The main parts of the translation are:
\begin{itemize}
  \item Translating inline recursion of the form $\mu\alpha.\S$ to explicit recursion.
...
\begin{figure}[tp]
  \begin{mathpar}
    \RuleExpValueReady \and
    \RuleExpConstReady \and
    \RuleParReady \and
    \RuleNuReady \and
    \RuleParBlocked \and
    \RuleNuBlockedHere \and
    \RuleNuBlockedHereAcq \and
    \RuleNuBlockedThere
  \end{mathpar}
  where
  \[
    ...
    \end{array}
  \]
  \caption{Ready and Blocked Processes (Ready $\Proc$, Blocked $\Proc$)}
