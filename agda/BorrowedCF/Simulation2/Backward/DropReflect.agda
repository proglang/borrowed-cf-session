...
module BorrowedCF.Simulation2.Backward.DropReflect where
...
open import BorrowedCF.Simulation.TranslationProperties using (≡→≋; U-cong; U-⋯ₚ)
open import BorrowedCF.Simulation.Frames using (frame-plug*; frame*-⋯)
open import BorrowedCF.Simulation2.Backward.Drop
  using (νσᵈ; νσᵈ-VSub; drop-arg-decomp; drop-bodyeq; drop-image)
open import BorrowedCF.Simulation2.Backward.DropGo using (drop-front-force)
open import BorrowedCF.Simulation2.Backward.DropConfine using (drop-confine)
open import BorrowedCF.Simulation2.Backward.DropGoB using (νσᵈ⁰; drop-bodyeq0)
open import BorrowedCF.Simulation2.Backward.DropConfine using () renaming ()
open import BorrowedCF.Simulation2.Backward.DropCollapse using (drop-collapse)
open import BorrowedCF.Simulation.Theorems.SplitsH2 using (frame*-cong; F-⋯f*-fuse; ·ₖ-VSubᵣ)
open import BorrowedCF.Simulation2.Backward.Drop using () renaming ()
