...
The accompanying supplement contains omitted rules and auxiliary material;
cross-references into it are marked by an \textup{S-} prefix, such as
\cref{fig:omitted-predicates} or \cref{sec:appendix-types}, and link to the
corresponding location in the supplement.
