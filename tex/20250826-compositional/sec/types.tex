...
\begin{lemma}
  ...
  $\Ctx = \CtxPar{\Ctx[1]}{\Ctx[2]}$ such that $\Unr\Ctx[1]$ and $\Unr\T$ is
...
\begin{figure}
  \begin{align*}
    ...
    \T \grmeq
      &
        ...
        \TArr{\Mob}{\Dir,\Eff}\T\T \grmor \T \TPair \T \grmor \TSum\T\T \grmor \S 
        \tag{Types} \\
    \S \grmeq
  ...
  \begin{mathpar}
    ...
    \CtxExtUnord{\Ctx[1]}{\Ctx[2]} = \CtxExtUnord{\Ctx[2]}{\Ctx[1]} \and
    \CtxExt{\Ctx[1]}{(\CtxExt{\Ctx[2]}{\Ctx[3]})} =
    \CtxExt{(\CtxExt{\Ctx[1]}{\Ctx[2]})}{\Ctx[3]} \and
    \CtxExtUnord{\Ctx[1]}{(\CtxExtUnord{\Ctx[2]}{\Ctx[3]})} =
    \CtxExtUnord{(\CtxExtUnord{\Ctx[1]}{\Ctx[2]})}{\Ctx[3]} \\
    \inferrule{\Unr\Ctx}{\CtxPar \Ctx \Ctx = \Ctx} \and
    %\inferrule{\Unr\Ctx}{\CtxSeq \Ctx \Ctx = \Ctx} \and
    \inferrule{\Unr\Ctx[1]}{\CtxPar{\Ctx[1]}{\Ctx[2]}
      = \CtxSeq{\Ctx[1]}{\Ctx[2]}} \and
    \inferrule{\Unr\Ctx[2]}{\CtxPar{\Ctx[1]}{\Ctx[2]}
      = \CtxSeq{\Ctx[1]}{\Ctx[2]}}
  \end{mathpar}

  \medskip
  Subcontext relation for weakening. \js{The direction is changed in comparison
  to our earlier work. It now aligns better with direction of weakening rules
  and the exchange law of concurrent Kleene algebra. Keep or revert?}
  \begin{mathpar}
    \CtxExt{(\CtxPar{\Ctx[1]}{\Ctx[3]})}{(\CtxPar{\Ctx[2]}{\Ctx[4]})}
    \SubCtx
    \CtxPar{(\CtxExt{\Ctx[1]}{\Ctx[2]})}{(\CtxExt{\Ctx[3]}{\Ctx[4]})}

    % TODO: how does weakening factor in here?
    \inferrule{
      \Unr\Ctx
    }{
      \CtxEmpty
...
\begin{lemma}%[Monoidal properties of contexts]
  ...
  context equality.
  \begin{itemize}
    \item Sequential composition \textup{($\CtxSeq{\Ctx[1]}{\Ctx[2]}$)} forms a
      monoid with identity $\CtxEmpty$.
    \item Parallel composition \textup{($\CtxPar{\Ctx[1]}{\Ctx[2]}$)} forms a
