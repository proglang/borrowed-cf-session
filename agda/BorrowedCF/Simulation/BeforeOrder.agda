module BorrowedCF.Simulation.BeforeOrder where
...
open import BorrowedCF.Simulation.Confine using (count; unrCx⇒count0; count-≈; count-≈′; count-self; count-wk-suc)
open import BorrowedCF.Simulation.StructDom using (count-structNSeq-lt)
