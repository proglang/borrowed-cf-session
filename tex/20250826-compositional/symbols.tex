...
% Target
\newcommand*\TT[1][]{\targettypecolor{T_{#1}}}
...
% binders
\newcommand*\BindGroup[1][{}]{\procbindcolor{B_{#1}}}
\newcommand*\Bind[1][{}]{\procbindcolor{b_{#1}}}
...
\newcommand*\TCSplit{\TargetTermKeyword{rsplit}}
...
\newcommand*\TBind[1][{}]{\targetprocbindcolor{B_{#1}}}
...
% Target Values
\newcommand*\TV[1][]{\targettermcolor{v_{#1}}}
\newcommand*\TU[1][]{\targettermcolor{u_{#1}}}
