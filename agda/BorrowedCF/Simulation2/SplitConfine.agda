module BorrowedCF.Simulation2.SplitConfine where
...
--   BorrowedCF.Simulation.Theorems against the reworked paper-matching typing.
...
open import BorrowedCF.Simulation2.Confine using (count; count-self; count0⇒∉dom; ≼⇒count≤)
open import BorrowedCF.Simulation2.InvFrame using (strengthen-frame; inv-app; inv-var-count; lsplit-app-nonUnr; rsplit-app-nonUnr)
open import BorrowedCF.Simulation2.Strengthen using (strengthen-Proc-gen; Inverter; mk-thin)
open import BorrowedCF.Simulation2.HandleCount using (count-handle-γinner; splitN-eq; mp≡handle)
open import BorrowedCF.Simulation2.AcqInv using (acq-app-nonUnr)
open import BorrowedCF.Simulation2.AcqHandle using (count-handle-acq; acqN-eq; mp≡handle-acq)
