...
$\Ctx[1] \CtxSeq \Ctx[2]$ or $\Ctx[1] \CtxPar \Ctx[2]$.
...
\begin{figure}
  ...
  axioms
  \begin{mathpar}
    %\CtxEmpty\CtxSeq\Ctx = \Ctx \and
    %\Ctx\CtxSeq\CtxEmpty = \Ctx \and
    \CtxEmpty\CtxPar\Ctx = \Ctx \and
    %\Ctx\CtxPar\CtxEmpty = \Ctx \and
    ...
    %\inferrule{\Unr\Ctx}{\Ctx \CtxSeq \Ctx = \Ctx} \and
    \inferrule{\Unr\Ctx[1]}{\Ctx[1] \CtxPar \Ctx[2]
      = \Ctx[1] \CtxSeq \Ctx[2]} \and
    \inferrule{\Unr\Ctx[2]}{\Ctx[1] \CtxPar \Ctx[2]
      = \Ctx[1] \CtxSeq \Ctx[2]}
  \end{mathpar}
