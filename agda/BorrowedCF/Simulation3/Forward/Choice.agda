module BorrowedCF.Simulation3.Forward.Choice where
...
open import BorrowedCF.Simulation3.Support.TranslationProperties using (VChan; chanTriple-V; Value-subst; Ub-V)
