...
--   BorrowedCF.Simulation.RevCom (com-go): the ⊎ cleanup slot of the old codomain
...
module BorrowedCF.Simulation2.Backward.Com where
...
open import BorrowedCF.Simulation.Theorems.SplitsH2 using (F-⋯f*-fuse; frame*-cong; ·ₖ-VSubᵣ)
open import BorrowedCF.Simulation.Strengthen
  using (Inverter*; strengthen-Tm-gen*; strengthen-Proc-gen*; ↑*-↑ˡ; ↑*-↑ʳ)
open import BorrowedCF.Simulation.ReverseConfine using (strengthen-frame*; count-handle-comᴸ)
open import BorrowedCF.Simulation.RevGrindC using (count-handle-comᴿ; before-com-binderᴿ)
...
open import BorrowedCF.Simulation.RevComImage using (com-image-block1; recv-image-block2; pos⇒suc)
