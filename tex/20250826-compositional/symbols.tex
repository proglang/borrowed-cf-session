...
\newcommand*\NewMetaVar[3][]{\NewDocumentCommand #2 {s O{}} {#1{\IfBooleanTF{##1}{#3'}{#3}_{##2}}}}
...
% target Expressions
\NewMetaVar[\targettermcolor] \TE     e
\NewMetaVar[\targettermcolor] \TEVar  x
\NewMetaVar[\targettermcolor] \TEVary y
\newcommand*\TEAbs[2]{\targettermcolor{\lambda {#1}.{#2}}}
\newcommand*\TEApp[2]{\targettermcolor{{#1}\,{#2}}}
\newcommand*\TEInj[2]{\targettermcolor{\Keyword{inj$_{#1}$}{#2}}}
\newcommand*\TEPair[2]{\targettermcolor{{#1} \otimes {#2}}}
\newcommand*\TETrip[3]{\TEPair{#1}{\TEPair{#2}{#3}}}
...
\NewDocumentCommand \TEChan {o m o}
  {
    \TEPair
      {\TEPair {\IfValueTF{#1}{#1}{\TCUnit}} {#2}}
      {\IfValueTF{#3}{#3}{\TCUnit}}
  }
...
\newcommand*\TCFork{\TargetTermKeyword{fork}}
\newcommand*\TCSplit{\TargetTermKeyword{lsplit}}
\newcommand*\TCSSplit{\TargetTermKeyword{rsplit}}
\newcommand*\TCNew{\TargetTermKeyword{new}}
\newcommand*\TCLink{\TargetTermKeyword{link}}
\newcommand*\TCWait{\TargetTermKeyword{wait}}
\newcommand*\TCTerm{\TargetTermKeyword{close}}
\newcommand*\TCSend{\TargetTermKeyword{send}}
\newcommand*\TCRecv{\TargetTermKeyword{recv}}
...
\newcommand*\TCAcq{\TargetTermKeyword{acquire}}
...
% Flagged Contexts
\NewMetaVar[\termcolor] \FC {\mathcal{F}}
\newcommand*\FCapp[2][]{\termcolor{\FC[1][#2]}}

% Configuration Contexts
\NewMetaVar[\termcolor] \CC {\mathcal{G}}
\newcommand*\CCapp[2][]{\termcolor{\CC[1][#2]}}
...
\newcommand*\TPNew[2][xy]{\targetproccolor{(\nu #1){#2}}}
\newcommand*\TPPar[2]{\targetproccolor{{#1} \,\|\, {#2}}}
\NewDocumentCommand \TPSync {s m m} {\targetproccolor{%
    (\varphi \IfBooleanT{#1}{{}^{*}} #2){#3}%
}}
...
% Expression Typing
\NewDocumentCommand \HasType {o m m m}
  {
    {#2} \vdash {#3} : {#4} \IfValueT{#1}{\mid{#1}}
  }
...
\newcommand*\TransExp[1][\Sub]{\stackrel{#1}{\TrRel{}}}
\newcommand\TransProc[1][\Sub]{\stackrel{#1}{\TrRel{\!P}}}
\newcommand\TransBind[1][\Sub]{\stackrel{#1}{\TrRel{\!B}}}
