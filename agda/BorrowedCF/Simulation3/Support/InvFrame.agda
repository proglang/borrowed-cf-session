module BorrowedCF.Simulation3.Support.InvFrame where
...
open import BorrowedCF.Simulation3.Support.Confine
open import BorrowedCF.Simulation3.Support.HandleLinear using (¬Unr-seq)
open import BorrowedCF.Context.Join using (biasedDir; join)
import BorrowedCF.Context.Substitution as 𝐂S
open import BorrowedCF.Simulation3.Support.Strengthen using (Inverter; inv↑; strengthen-Tm-gen)
