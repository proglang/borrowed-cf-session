...
types with borrowing, a calculus we call \thecalculus. While CFSTs'
...
\item We identify session-type splitting as the central operation
  behind borrowing for CFSTs. Splitting must compute a borrowed prefix
  and a residual suffix modulo the equational theory of CFSTs,
  including sequential composition, choices, \lstinline{Skip}, and
  recursive unfolding.
