...
$\Mobile$/$\Bounded$/$\Skips$ (\cref{fig:bounded-session-types}); typing rules
of constants (\cref{fig:constant-typing}); typing rules (constants, variables,
functions: \cref{fig:typing-functions}; pairs, let, case, weakening:
\cref{fig:typing}; processes: \cref{fig:process-typing})
