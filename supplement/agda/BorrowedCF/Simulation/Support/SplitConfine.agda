module BorrowedCF.Simulation.Support.SplitConfine where
...
--   BorrowedCF.Simulation.Support.Theorems against the reworked paper-matching typing.
...
open import BorrowedCF.Simulation.Support.InvFrame using (strengthen-frame; inv-app; inv-var-count; lsplit-app-nonUnr; rsplit-app-nonUnr)
open import BorrowedCF.Simulation.Support.Strengthen using (strengthen-Proc-gen; Inverter; mk-thin)
open import BorrowedCF.Simulation.Support.HandleCount using (count-handle-γinner; splitN-eq; mp≡handle
  ; count-handle-γinnerq; splitN-eqq; mp≡handleq)
open import BorrowedCF.Simulation.Support.AcqInv using (acq-app-nonUnr)
open import BorrowedCF.Simulation.Support.AcqHandle using (count-handle-acq; acqN-eq; mp≡handle-acq)
