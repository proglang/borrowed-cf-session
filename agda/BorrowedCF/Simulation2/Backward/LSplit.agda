...
--   BorrowedCF.Simulation.RevLSplit (SplitRenamings moved to Terms and now takes
--   a `sum B`-shaped ℕ; the ⊎ cleanup slot of the codomain collapsed).
module BorrowedCF.Simulation2.Backward.LSplit where
...
open import BorrowedCF.Simulation.InvFrame using (fn-lsplit-dom; strengthen-frame)
