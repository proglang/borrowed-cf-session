...
module BorrowedCF.Simulation.Support.RevDropConfine where
...
open import BorrowedCF.Simulation.Support.BeforeOrder using (before; before-⋯ᵣ-inj; before-structNSeq)
open import BorrowedCF.Simulation.Support.RevGrindC using (inj-wkʳ)
open import BorrowedCF.Simulation.Support.RevComConfine using (bindCtx′-NoAcq)
open import BorrowedCF.Simulation.Support.CloseVacuityProbe
  using (NoAcq; noAcq-;-fst; noAcq-≃; new-end⇒noAcq)
import BorrowedCF.Simulation.Support.CloseVacuityProbe as CV
