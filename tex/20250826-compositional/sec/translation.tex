...
%     \TrT{\S} &= \TBChan &
%     \TrT{{\T[1]} \TPair {\T[2]}} &= \TTProd {\TrT{\T[1]}} {\TrT{\T[2]}} \\
%     && \TrT{\TSum {\T[1]} {\T[2]}} &= \TTSum {\TrT{\T[1]}} {\TrT{\T[2]}}
%     \\[\smallskipamount]
%     \TrCtx{\CtxEmpty} &= \TCtxEmpty &
%     \TrCtx{\Ctx[1] \CtxSeq \Ctx[2]} &= \TCtxApp{\TrCtx{\Ctx[1]}}{\TrCtx{\Ctx[2]}} \\
%     \TrCtx{\CtxVar\EVar\T} &= \TCtxExt{\TCtxEmpty}{\TCtxVar\EVar{\TrT\T}} &
%     \TrCtx{\Ctx[1] \CtxPar \Ctx[2]} &= \TCtxApp{\TrCtx{\Ctx[1]}}{\TrCtx{\Ctx[2]}}
%   \end{align*}
