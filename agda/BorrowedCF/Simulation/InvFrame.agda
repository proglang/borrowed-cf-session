...
open import BorrowedCF.Simulation.HandleLinear using (¬Unr-seq)
...
open import BorrowedCF.Simulation.Base using (funext)
...
fn-lsplit-dom (T-Const (`lsplit _ s′)) = s′ , ≃-refl
...
fn-rsplit-dom (T-Const (`rsplit _ s′)) = s′ , ≃-refl
