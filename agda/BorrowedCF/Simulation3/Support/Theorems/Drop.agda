module BorrowedCF.Simulation3.Support.Theorems.Drop where
...
open import BorrowedCF.Simulation3.Support.Frames using (frame-plug*; frame*-⋯; frame-plug₁; ++ₛ-VSub; weaken-VSub)
open import BorrowedCF.Simulation3.Support.TranslationProperties using (VChan; Value-subst; chanTriple-V)
open T using (inv-∥; inv-ν; inv-⟪⟫; BindCtx; BindCtx′; last; cons-ret/acq; cons-acq; nil; cons)
open import BorrowedCF.Simulation3.Support.InvFrame using (inv-app; arg-type; strengthen-frame)
open import BorrowedCF.Simulation3.Support.Theorems.B1VacProbe
  using ( NoRet; new⇒noRet; noRet-≃; ¬noRet-ret
        ; RetTip; retTip-Sc-skips; noRet-front-cons; retTip-≃; noRet-;-fst )
open import BorrowedCF.Simulation3.Support.Theorems.B1VacProbe as VP using ()
