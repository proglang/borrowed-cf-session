...
--   drop-image call.
module BorrowedCF.Simulation2.Backward.DropGo where
...
open import BorrowedCF.Simulation.ReverseInv using (close-arg-var)
open import BorrowedCF.Simulation2.Backward.Drop using (νσᵈ; drop-arg-decomp; drop-image)
open import BorrowedCF.Simulation.RevDropConfine using (before-drop-binderᴸ; count-handle-groupᴸ; head-block-NoAcq)
open import BorrowedCF.Simulation.RevComConfine using (frames-𝕀; com-xS-min)
open import BorrowedCF.Simulation.RevGrindA using (barevar-arg-count; choice-¬before; 𝕀≤⇒≡𝕀)
open import BorrowedCF.Simulation.CloseVacuityProbe using (¬mobile-of)
