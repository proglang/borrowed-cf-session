...
closing/waiting, return/acquire (new to this work), and recursion.
...
A binder group $\BindGroup$ is a flat list of channel names $\EVar$ and
...
channel introduction with two binder groups that scope over the body.
