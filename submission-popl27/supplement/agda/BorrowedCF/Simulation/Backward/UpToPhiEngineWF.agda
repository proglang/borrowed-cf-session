...
--       a genuine φ-drop (BorrowedCF.Simulation.Backward.DropNotAdmin:
...
module BorrowedCF.Simulation.Backward.UpToPhiEngineWF where
...
open import BorrowedCF.Simulation.Support.RevAdmin using (_≈_; ≈-sym; ≈-trans; ≋⇒≈)
open import BorrowedCF.Simulation.Support.RevCongStrong using (∣_∣)
