...
\DefRule {RSplit} {
  ...
  {\TArr{\MobMobile}{\DirUnord,\EffPure} {\SSeq\S\TVar} {\TPairUnord{\SSeq{\S}{\SDrop}}{\SSeq\SAcq\TVar}}}
    \EffPure
    [\CSEmpty]
}
...
\DefRule {Select} {
  \InferType
    ...
    {\T}
    \Eff \\
  \NormaliseType \T {\SChoice{\ell:\S[\ell]}{\ell\in L}}
}{
  \InferType
    {\EApp{\CSelect k}{\E}}
    {\S[k]}
...
\DefRule {Branch} {
  \InferType
    ...
    {\T}
    \Eff \\
  \NormaliseType \T {\SBranch{\ell:\S[\ell]}{\ell\in L}}
}{
  \InferType
    {\EApp{\CBranch}{\E}}
...
% A-Annot
\DefRule {Annot} {
  \CheckType \E {\T} {\Eff} [\CSet] \\
  \NormaliseType {\T} {\T*}
} {
  \InferType {\E : \T} {\T*} \Eff [\CSet]
}
