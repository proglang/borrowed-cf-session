...
--   proved in its own BorrowedCF.Simulation.Forward.<Op> module.
module BorrowedCF.Simulation.Forward where
...
open import BorrowedCF.Simulation.Forward.Fork  using (U-fork)  public
open import BorrowedCF.Simulation.Forward.New   using (U-new)   public
open import BorrowedCF.Simulation.Forward.Close  using (U-close)  public
open import BorrowedCF.Simulation.Forward.Com    using (U-com)    public
open import BorrowedCF.Simulation.Forward.Choice  using (U-choice)  public
open import BorrowedCF.Simulation.Forward.LSplit  using (U-lsplit→)  public
open import BorrowedCF.Simulation.Forward.RSplit  using (U-rsplit→)  public
open import BorrowedCF.Simulation.Forward.Discard using (U-discard)  public
open import BorrowedCF.Simulation.Forward.Drop    using (U-drop→)   public
open import BorrowedCF.Simulation.Forward.Acq     using (U-acq→)    public
