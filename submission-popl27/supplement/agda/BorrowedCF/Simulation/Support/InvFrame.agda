module BorrowedCF.Simulation.Support.InvFrame where
...
open import BorrowedCF.Simulation.Support.HandleLinear using (¬Unr-seq)
open import BorrowedCF.Context.Join using (biasedDir; join)
import BorrowedCF.Context.Substitution as 𝐂S
open import BorrowedCF.Simulation.Support.Strengthen using (Inverter; inv↑; strengthen-Tm-gen)
open import BorrowedCF.Simulation.Support.Base using (funext)
