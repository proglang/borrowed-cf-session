...
\NewDocumentCommand\TyTransProc{O{\Ctx} m O{\Sub} m}{
  #1 \vdash \proccolor{#2} \TransProc[#3] \targetproccolor{#4}
}
\NewDocumentCommand\TyTransBind{O{\Ctx} m m m m}{
  #1 \vdash \proccolor{#2} \TransBind[#3]{#4}{#5}
}
