...
⊢-↓-height fv⊆ (T-Pair p/s seq⇒p d₁ d₂) = substγ-height _ (T-Pair p/s seq⇒p (⊢-↓ (S.⊆-trans (S.p⊆p∪q _) fv⊆) d₁) (⊢-↓ (S.⊆-trans (S.q⊆p∪q _ _) fv⊆) d₂)) ■ cong suc (cong₂ Nat._⊔_ (⊢-↓-height (S.⊆-trans (S.p⊆p∪q _) fv⊆) d₁) (⊢-↓-height (S.⊆-trans (S.q⊆p∪q _ _) fv⊆) d₂))
⊢-↓-height fv⊆ (T-Seq unr-T d₁ d₂) = cong suc (cong₂ Nat._⊔_ (⊢-↓-height (S.⊆-trans (S.p⊆p∪q _) fv⊆) d₁) (⊢-↓-height (S.⊆-trans (S.q⊆p∪q _ _) fv⊆) d₂))
⊢-↓-height {X = X} fv⊆ (T-Let p/s {γ₂ = γ₂} d₁ d₂) = substγ-height _ (T-Let p/s (⊢-↓ (S.⊆-trans (S.p⊆p∪q _) fv⊆) d₁) (subst (λ z → _ ; z ⊢ _ ∶ _ ∣ _) (↓-bind1 p/s γ₂ X) (⊢-↓ (fvClose-⊆ (S.⊆-trans (S.q⊆p∪q _ _) fv⊆)) d₂))) ■ cong suc (cong₂ Nat._⊔_ (⊢-↓-height (S.⊆-trans (S.p⊆p∪q _) fv⊆) d₁) (substγ-height _ (⊢-↓ (fvClose-⊆ (S.⊆-trans (S.q⊆p∪q _ _) fv⊆)) d₂) ■ ⊢-↓-height (fvClose-⊆ (S.⊆-trans (S.q⊆p∪q _ _) fv⊆)) d₂))
⊢-↓-height {X = X} fv⊆ (T-LetPair {d = dr} p/s {γ₂ = γ₂} d₁ d₂) = substγ-height _ (T-LetPair p/s (⊢-↓ (S.⊆-trans (S.p⊆p∪q _) fv⊆) d₁) (subst (λ z → _ ; z ⊢ _ ∶ _ ∣ _) (↓-letpair p/s dr γ₂ X) (⊢-↓ (fvClose*2-⊆ (S.⊆-trans (S.q⊆p∪q _ _) fv⊆)) d₂))) ■ cong suc (cong₂ Nat._⊔_ (⊢-↓-height (S.⊆-trans (S.p⊆p∪q _) fv⊆) d₁) (substγ-height _ (⊢-↓ (fvClose*2-⊆ (S.⊆-trans (S.q⊆p∪q _ _) fv⊆)) d₂) ■ ⊢-↓-height (fvClose*2-⊆ (S.⊆-trans (S.q⊆p∪q _ _) fv⊆)) d₂))
⊢-↓-height fv⊆ (T-Inj d) = cong suc (⊢-↓-height fv⊆ d)
⊢-↓-height {X = X} fv⊆ (T-Case p/s {γ₂ = γ₂} de d₁ d₂) = substγ-height _ (T-Case p/s (⊢-↓ (S.⊆-trans (S.p⊆p∪q _) fv⊆) de) (subst (λ z → _ ; z ⊢ _ ∶ _ ∣ _) (↓-bind1 p/s γ₂ X) (⊢-↓ (fvClose-⊆ (S.⊆-trans (S.p⊆p∪q _) (S.⊆-trans (S.q⊆p∪q _ _) fv⊆))) d₁)) (subst (λ z → _ ; z ⊢ _ ∶ _ ∣ _) (↓-bind1 p/s γ₂ X) (⊢-↓ (fvClose-⊆ (S.⊆-trans (S.q⊆p∪q _ _) (S.⊆-trans (S.q⊆p∪q _ _) fv⊆))) d₂))) ■ cong suc (cong₂ Nat._⊔_ (cong₂ Nat._⊔_ (⊢-↓-height (S.⊆-trans (S.p⊆p∪q _) fv⊆) de) (substγ-height _ (⊢-↓ (fvClose-⊆ (S.⊆-trans (S.p⊆p∪q _) (S.⊆-trans (S.q⊆p∪q _ _) fv⊆))) d₁) ■ ⊢-↓-height (fvClose-⊆ (S.⊆-trans (S.p⊆p∪q _) (S.⊆-trans (S.q⊆p∪q _ _) fv⊆))) d₁)) (substγ-height _ (⊢-↓ (fvClose-⊆ (S.⊆-trans (S.q⊆p∪q _ _) (S.⊆-trans (S.q⊆p∪q _ _) fv⊆))) d₂) ■ ⊢-↓-height (fvClose-⊆ (S.⊆-trans (S.q⊆p∪q _ _) (S.⊆-trans (S.q⊆p∪q _ _) fv⊆))) d₂))
