...
module BorrowedCF.Simulation.Backward.DropReflectGo where
...
open import BorrowedCF.Simulation.Backward.Drop using (νσᵈ)
open import BorrowedCF.Simulation.Backward.DropReflect using (drop-goB-good)
