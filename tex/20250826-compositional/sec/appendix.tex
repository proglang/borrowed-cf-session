...
\begin{proof}
  ...
  blocked thread. A value of type $\BUnit$ in a session context is $\CUnit$ by
  canonical forms.
\end{proof}
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item $\ProcQ$ blocked. By the definition of $\Blocked{}$, every thread of
      ...
      \begin{enumerate}
        \item A thread is blocked on a fragment of $\BindGroup[1]$ or
        ...
        \item Case (1) does not apply, and two distinct threads are blocked at
