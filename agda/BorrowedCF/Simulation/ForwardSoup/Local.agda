...
open import BorrowedCF.Simulation.ForwardSoup.Local.RSplit using (U-rsplit-local)
...
local-sim Γ-S ⊢P Vsigma separated image
  (TypedReduction.R-RSplit {E = E}) =
  U-rsplit-local {E = E} Γ-S ⊢P Vsigma separated image
local-sim Γ-S ⊢P Vsigma separated image
