module BorrowedCF.Simulation.Forward.Choice where
...
open import BorrowedCF.Simulation.Support.TranslationProperties using (VChan; chanTriple-V; Value-subst; Ub-V)
