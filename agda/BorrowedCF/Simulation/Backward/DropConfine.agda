...
module BorrowedCF.Simulation.Backward.DropConfine where

open import BorrowedCF.Simulation.Base
import BorrowedCF.Processes.Typed             as TP
open import BorrowedCF.Context using (Ctx; Struct)
open import BorrowedCF.Reduction.Base using (ChanCx; Frame*; _[_]*; _⋯ᶠ*_)
open import BorrowedCF.Simulation.Support.Strengthen using (Inverter*; strengthen-Proc-gen*)
open import BorrowedCF.Simulation.Support.ReverseConfine using (strengthen-frame*)
open import BorrowedCF.Simulation.Support.RevDropConfine using (count-handle-groupᴸ)
open import BorrowedCF.Simulation.Support.Confine using (count; count-self; ≼⇒count≤; count0⇒∉dom)
open import BorrowedCF.Simulation.Backward.Drop using (fn-drop-dom)
import BorrowedCF.Simulation.Support.InvFrame as IF
open import BorrowedCF.Types using (Unr; unr-≃; _≃_; ≃-trans; ≃-sym)
open import BorrowedCF.Simulation.Support.InvFrame using (arg-type; inv-var-count)
