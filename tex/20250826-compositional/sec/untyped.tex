...
\begin{figure}
  ...
  \end{align*}
  \caption{Syntax of translated rocesses configurations $\TProc$ and synchronization flags $\Flag$}
...
\begin{figure}
  \textcolor{red}{Wrong and incomplete!}
  \begin{mathpar}
  ...
  \end{mathpar}
  \caption{Translation of expressions ($\HasType \Ctx \E \T \TransExp \TE*$) and processes ($\ProcHasType \Ctx \Proc \TransProc \TProc*$)}
...
%
  For any context $\Ctx$ and substitution $\Sub$
  %with $\TCtx*=\TrCtx\Ctx\setminus\dom\Sub$
%
  \begin{enumerate}
    \item If
