module BorrowedCF.Simulation.Support.RevComConfine where
...
open import BorrowedCF.Simulation.Support.Confine using (count; +≡0; count-join-Dir)
open import BorrowedCF.Simulation.Support.BeforeOrder using (before; before⇒mem)
...
open import BorrowedCF.Simulation.Support.CloseVacuityProbe using (NoAcq; new⇒noAcq; new-end⇒noAcq; noAcq-≃; noAcq-;-fst; noAcq-;-snd; ¬mobile-of)
