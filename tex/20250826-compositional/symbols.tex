...
\newcommand{\ctxcolor}{\textcolor{ACMPurple}}
\newcommand{\typecolor}{\textcolor{ACMPurple}}
...
\newcommand{\dircolor}{\textcolor{ACMOrange}}
\newcommand{\mobcolor}{\textcolor{ACMGreen}}
...
\NewDocumentCommand \InferType {O{\Eff} O{\Ctx} m m}
  {
    \ctxcolor{#2} \vdash {#3} \Rightarrow {#4} \mid {#1}
  }
\NewDocumentCommand \CheckType {O{\Eff} O{\Ctx} m m}
  {
    \ctxcolor{#2} \vdash {#3} \Leftarrow {#4} \mid {#1}
  }
