...
module BorrowedCF.Simulation.Forward.Discard where
...
open import BorrowedCF.Simulation.Support.Frames using (frame-plug*; frame-plug₁; frame*-⋯; ++ₛ-VSub; weaken-VSub)
